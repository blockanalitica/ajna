...
const table_tab_1coin_title = ({ name = "Ethereum", symbol = "ETH" }) => (
...
const table_tab_title_coin_subtitle_val_change = ({
  ...
  title_val_change = 0,
  subtitle_val_change = 0,
  subtitle_dash_if_zero = false,
  subtitle_hide_if_zero = false,
  title_val_change_prefix = null,
  subtitle_val_change_prefix = null,
}) => (
  <div className="flex justify-end items-center p-4">
    <div className="flex flex-col items-end">
      <div className="flex justify-start items-center">
        <Value value={title} prefix={title_prefix} decimals={2} compact suffix={icon} />
        <ValueChange
